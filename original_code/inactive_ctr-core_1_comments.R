...
################################################################################
# Print initial state
cat("Initial nodes:", V(attack_graph)$name, "\n")
cat("Initial target nodes (out-degree=0):", 
    V(attack_graph)[degree(attack_graph, mode="out")==0]$name, "\n")
